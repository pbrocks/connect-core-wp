...
class Sample_Plugins_List {
	...
	public static function add_menu_csc_list_table_page() {
		...
		add_submenu_page( 'connect-to-multisite.php', 'webdev MultiSite Plugins', 'webdev MultiSite Plugins', 'manage_options', 'csc-list-table21.php', array( __CLASS__, 'list_table_page' ) );
	}
	...
	public static function list_table_page() {
		$csc_list_table = new Campbells_Active_Plugin_Data();
		...
		<div class="wrap">
			...
			<form method="post">
				...
				<?php $csc_list_table->display_plugin_data(); ?>
			</form>
...
class Campbells_Active_Plugin_Data {
	...
	function network_menu() {
		$hook = add_submenu_page( 'connect-to-multisite.php', __( 'Campbells Plugin Data', 'wds-apd' ), __( 'Campbells Active Plugin Data', 'wds-apd' ), 'manage_options', 'csc-plugin-data.php', array( $this, 'display_plugin_data' ) );
